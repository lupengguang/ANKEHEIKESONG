...
SECRET_KEY = 'rebucca-insecure-oam*2x=@ynuv5w*&$*yc-1cjsku-b2@$x*t9!swd+n0glv76'
...
MIDDLEWARE = [
    'app.cors_middleware.CorsMiddleware',  # CORS 跨域（须在最前，直接应答预检）
...
SESSION_COOKIE_NAME = 'RebuccaSessionID'

# 前端 Vite 开发服务器（跨端口请求属于跨源，需加入 CSRF 白名单）
