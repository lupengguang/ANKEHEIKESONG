# Generated by Django 6.1.1 on 2026-09-22 14:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api_key', models.CharField(default='', max_length=200, verbose_name='API密钥')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('camera_sequence', models.JSONField(default=list, verbose_name='出现摄像头序列')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['track_id'], name='bt_track_idx')],
            },
        ),
        migrations.CreateModel(
            name='BrainEvent',
            fields=[
                ...
                ('event_type', models.CharField(default='motion', max_length=50, verbose_name='事件类型')),
                ('scene_description', models.TextField(default='', verbose_name='场景描述(VLM原始输出)')),
                ('subject', models.CharField(default='', max_length=100, verbose_name='识别主体(人物/宠物/物品)')),
                ('action', models.CharField(default='', max_length=200, verbose_name='主体行为')),
                ('anomaly_score', models.FloatField(default=0.0, verbose_name='异常评分(0~1, 越高越可疑)')),
                ('snapshot_path', models.CharField(default='', max_length=500, verbose_name='快照路径')),
                ('video_clip_path', models.CharField(default='', max_length=500, verbose_name='视频片段路径')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='入库时间')),
            ],
            options={
                'verbose_name': '脑中枢事件',
                ...
                'indexes': [models.Index(fields=['camera_id', '-timestamp'], name='be_cam_ts_idx'), models.Index(fields=['-timestamp'], name='be_ts_idx')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_type', models.CharField(default='unknown', max_length=50, verbose_name='人员类型')),
                ('person_confidence', models.FloatField(default=0.0, verbose_name='人员识别置信度(0~1)')),
                ('timestamp', models.DateTimeField(verbose_name='事件发生时间')),
                ('snapshot_path', models.CharField(default='', max_length=500, verbose_name='快照路径')),
                ('actions_taken', models.JSONField(default=list, verbose_name='已执行的动作')),
                ('notified', models.IntegerField(default=0, verbose_name='是否已通知')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='入库时间')),
            ],
            options={
                'verbose_name': '户外事件',
                ...
                'indexes': [models.Index(fields=['camera_id', '-timestamp'], name='oe_cam_ts_idx'), models.Index(fields=['-timestamp'], name='oe_ts_idx')],
            },
        ),
        migrations.CreateModel(
            name='OutdoorSceneConfig',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('camera_id', models.IntegerField(verbose_name='摄像头ID')),
                ('scene_type', models.CharField(max_length=50, verbose_name='场景类型')),
                ('enabled', models.IntegerField(default=1, verbose_name='是否启用')),
                ('config', models.JSONField(default=dict, verbose_name='场景参数JSON')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('last_update_time', models.DateTimeField(auto_now_add=True, verbose_name='更新时间')),
            ],
            options={
                ...
                'indexes': [models.Index(fields=['camera_id'], name='osc_cam_idx')],
            },
        ),
        migrations.CreateModel(
            name='StreamModel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.CharField(default='', max_length=500, verbose_name='简要摘要')),
                ('anomaly_count', models.IntegerField(default=0, verbose_name='本周异常事件数')),
                ('report_content', models.JSONField(default=dict, verbose_name='详细报告内容')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
            ],
            options={
                'verbose_name': '安全周报',
                ...
                'indexes': [models.Index(fields=['-week_start'], name='wr_ws_idx')],
            },
        ),
        migrations.CreateModel(
            name='ZoneModel',
